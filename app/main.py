...
시작 방법:
    uvicorn app.main:app --host 0.0.0.0 --port 5503 --reload
"""
...
from app.http.catalog_endpoints import router
from app.system.settings import settings
from app.system.logging import setup_logging, get_logger
