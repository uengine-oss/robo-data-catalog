"""ROBO Data Catalog 로깅 유틸리티

사용법:
    from app.system.logging import setup_logging, get_logger, log_process
"""
...
def log_process(
    ...
    logging.log(level, f"[{ctx}:{stage_text}] {message}", exc_info=real_exc_info)
